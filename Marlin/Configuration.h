...
#define CUSTOM_MACHINE_NAME "Ping Pings Bear"  //EJC CHANGED 
...
#define TEMP_WINDOW              5  // (°C) Temperature proximity for the "temperature reached" timer    //EJC 
#define TEMP_HYSTERESIS          8  // (°C) Temperature proximity considered "close enough" to the target

#define TEMP_BED_RESIDENCY_TIME 10  // (seconds) Time to wait for bed to "settle" in M190
#define TEMP_BED_WINDOW          5  // (°C) Temperature proximity for the "temperature reached" timer   //EJC
...
#define DEFAULT_bedKi 3.78
#define DEFAULT_bedKd 565.86
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 200, 200, 10000 }
